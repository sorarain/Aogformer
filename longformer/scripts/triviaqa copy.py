...
from lightning.pytorch.loggers import TensorBoardLogger as TestTubeLogger
...
def main(args):
    ...
    trainer = pl.Trainer(devices=args.gpus, strategy="ddp" if args.gpus and args.gpus > 1 else "auto", accelerator="gpu",
                        ...
                        # check_val_every_n_epoch = args.val_every,
                         ...
                         val_check_interval=args.val_percent_check,
                        ...
                        #  callbacks = [GradientAccumulationScheduler(scheduling={args.epochs-1: args.batch_size})]
                         )
    if not args.test:
