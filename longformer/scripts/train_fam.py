...
from FAM import RobertaFAMForMaskedLM
...
training_args, model_args = parser.parse_args_into_dataclasses(look_for_args_file=False, args=[
    '--output_dir', '/root/autodl-tmp/users/hyb/longformer/tmp/fam/v1',
    '--warmup_steps', '2000',
...
model = RobertaFAMForMaskedLM.from_pretrained('/root/autodl-tmp/users/hyb/longformer/tmp/famformer-4096')
model = RobertaFAMForMaskedLM(config=model.config)
